...
████████████████████████████████████████████████████████████████████████████
    ...
    Description: gzCloneReference is a tool for manage the name of the Maya 
...
scriptName = 'gzCloneReference'
scriptIcon = 'gzCloneReferenceIcon.png'
...
def install():
    ...
    for currentVersion in installedMayas:
        ...
        print(Path('Copying gzCloneReference to ' + mayaUserPath + currentVersion + '/scripts/gzCloneReference/ ...' ))
        sleep(0.2)
        ...
        for mayaShelfPath in mayaShelvesPath:        
            ...
            if path.exists(mayaShelfPath):
                if path.isfile(mayaShelfPath + scriptShelf):
                    ...
                    #filedata = re.sub('//begins_gzCloneReference?(.*?)//ends_gzCloneReference', '', filedata, flags=re.DOTALL)
